                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4 offset-lg-1">
                            ...
                            <div className="onovo-text onovo-text-white">
                                ...
                                <p style={{"opacity": "0.6"}}>
                                    <a href="tel:+10204302973" className="onovo-lnk lnk--white" target="_blank">+92 3097929132</a><br />
                                    <a href="mailto:username@domain.com" className="onovo-lnk lnk--white" target="_blank">primebyanas@gmail.com</a>
                                </p>
                            </div>
